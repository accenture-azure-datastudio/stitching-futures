...
function FakeSidebar({ isOpen, setIsOpen }) {
    ...
    const mockClothBanksDataWest = {
        data: [
          {
            name: "London Community Cloth Bank",
            address: "22B Baker Street, London, NW1 6XE",
            postcode: "NW1 6XE",
            needs: {
              needs: "Men's shoes sizes 8-10\n  Women's winter coats size M-L\n  Children's books"
            }
          },
          {
            name: "The London Helping Hands",
            address: "221B Baker Street, London, NW1 6XE",
            postcode:  "NW1 6XE",
            needs: {
              needs: "Baby clothes for 0-6 months\n  Blankets, Women's shoes sizes 5-7"
            }
          },
          {
            name: "East London Cloth Share",
            address: "48 Commercial Street, London, E1 6LT",
            postcode:"E1 6LT",
            needs: {
              needs: "Jeans and trousers sizes 30-34 \n  Kids' educational toys \n  Men's waterproof jackets size L-XL"
            }
          },
          {
            name: "Southwark Clothing Relief",
            address: "110 Union Street, London, SE1 0NL",
            postcode:"SE1 0NL",
            needs: {
              needs: "School uniforms for ages 6-12 \n Ladies' handbags, Newborn essentials"
            }
          },
          {
            name: "Greenwich Cloth Bank",
            address: "30 Greenwich Church Street, London, SE10 9BL",
            postcode:"SE10 9BL",
            needs: {
              needs: "Warm socks all sizes \n  Teenage clothing \n Men's work boots sizes 9-12"
            }
          }
        ]
      };
    ...
    const fetchFoodbanks = async () => {
        setIsLoading(true);
        setError('');
        console.log('Simulated fetchFoodbanks called');
        if (!postcode) {
        ...
        setTimeout(() => {
            // Directly use mock data instead of making an API call
            const listToUse = postcode.endsWith('H') ? mockClothBanksDataWest.data : postcode.endsWith('Y') ? mockClothBanksDataEast.data : [];
            setFoodbanks(listToUse);
